...
//    [self baseCoreTextUsingMethod];
    ...
    if (self.data) {
        ...
        for (CoreTextImageData *imageData in self.data.imageArray) {
            //将图片绘制到上下文中
//            NSString *path = [[NSBundle mainBundle] pathForResource:imageData.name ofType:nil];
//            UIImage *image = [UIImage imageWithContentsOfFile:path];
            CGContextDrawImage(context, imageData.imagePosition, [UIImage imageNamed:@"icon"].CGImage);
        }
    }
